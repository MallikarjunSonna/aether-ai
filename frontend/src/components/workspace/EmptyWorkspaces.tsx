...
export function EmptyWorkspaces({ onCreate }: EmptyWorkspacesProps) {
  return (
    <div className="flex min-h-[50vh] flex-col items-center justify-center text-center">
      ...
      <h2 className="mt-6 text-lg font-semibold text-ink">No workspaces yet</h2>
      <p className="mt-2 max-w-sm text-sm leading-relaxed text-muted">
        Create your first workspace to organize your AI projects and collaborate with your team.
      </p>
      <button
        onClick={onCreate}
