    ...
    >
      <div className="w-full max-w-3xl rounded-xl border border-line bg-surface shadow-lg max-h-[90vh] flex flex-col">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 px-6 py-5 overflow-y-auto flex-1">
          <div>
            <label htmlFor="edit-prompt-title" className="block text-sm font-medium text-ink">
            ...
            <input
              ...
              aria-describedby={errors.title ? "edit-prompt-title-error" : undefined}
            ...
            />
            {errors.title && (
              <p id="edit-prompt-title-error" className="mt-1.5 text-xs text-error">
                {errors.title}
              </p>
            )}
          </div>
          ...
          <div>
            <label htmlFor="edit-prompt-description" className="block text-sm font-medium text-ink">
              Description
            </label>
            <input
          ...
          <div>
            <label htmlFor="edit-prompt-content" className="block text-sm font-medium text-ink">
            ...
            <textarea
              ...
              aria-describedby={errors.content ? "edit-prompt-content-error" : undefined}
              rows={8}
            ...
            />
            {errors.content && (
              <p id="edit-prompt-content-error" className="mt-1.5 text-xs text-error">
                {errors.content}
              </p>
            )}
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="edit-prompt-category" className="block text-sm font-medium text-ink">
                Category
              </label>
              <select
            ...
            <div>
              <label htmlFor="edit-prompt-visibility" className="block text-sm font-medium text-ink">
                Visibility
              </label>
              <select
          ...
          <div>
            <label htmlFor="edit-prompt-tags" className="block text-sm font-medium text-ink">
              Tags
            </label>
            <input
              id="edit-prompt-tags"
