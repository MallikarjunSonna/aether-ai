...
const features = [
  {
    title: "AI Chat",
    description:
      "Production-ready conversations with streaming, memory, and provider flexibility built in.",
    icon: Bot,
  },
  {
    title: "Multi-Agent",
    description:
      "Design specialized agent teams that reason, collaborate, and execute complex workflows.",
    icon: Network,
  },
  {
    title: "Knowledge Base",
    description:
      "Turn enterprise content into accurate, permission-aware answers your teams can trust.",
    icon: Library,
  },
  {
    title: "Prompt Library",
    description: "Create, version, test, and share high-performing prompts across every workspace.",
    icon: FileCode2,
  },
  {
    title: "Analytics",
    description:
      "Monitor quality, latency, token usage, and cost from one real-time control plane.",
    icon: BarChart3,
  },
  {
    title: "Enterprise Security",
    description:
      "Protect every interaction with granular access, audit trails, and isolated workspaces.",
    icon: ShieldCheck,
  },
];
...
const trustItems = [
  {
    title: "Enterprise Security",
    description:
      "Granular access controls, audit-ready activity logs, and encryption at every layer.",
    icon: ShieldCheck,
  },
  {
    title: "Workspace Isolation",
    description:
      "Dedicated data boundaries keep every team, project, and knowledge source separated.",
    icon: Layers3,
  },
  {
    title: "Model Agnostic Architecture",
    description:
      "Use the best model for each workload without locking your platform to one provider.",
    icon: Boxes,
  },
];
          ...
          {workflowNodes.map((node, index) => (
            <div key={node.name}>
              ...
              {index < workflowNodes.length - 1 && (
                <div
                  className="relative mx-auto h-3 w-px overflow-hidden bg-line"
                  aria-hidden="true"
                >
                  <motion.span
                    animate={{ y: ["-100%", "100%"] }}
...
export function DashboardPage() {
  return (
    <div id="top">
          ...
          <div className="grid items-center gap-16 lg:grid-cols-[1.04fr_0.96fr] lg:gap-20">
            ...
            >
              ...
              <div className="mt-10 flex flex-col gap-3 sm:flex-row">
                <a
                  href="/signup"
                  className="group inline-flex items-center justify-center gap-2 rounded-md bg-primary px-5 py-3 text-sm font-semibold text-white shadow-md transition-all duration-fast hover:-translate-y-0.5 hover:bg-blue-600 hover:shadow-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400"
                >
                  Start Building
                  <ArrowRight
      ...
      <section
        className="border-y border-line/70 bg-surface/30 py-14 [content-visibility:auto]"
        aria-labelledby="technology-heading"
      >
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          <p
            id="technology-heading"
            className="mb-8 text-center text-xs font-medium uppercase tracking-[0.22em] text-muted"
          >
            Trusted technology. One unified platform.
          </p>
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-8">
            {technologies.map((technology, index) => (
              ...
              >
                <technology.icon
                  className={`h-6 w-6 transition-transform duration-normal group-hover:scale-110 ${technology.color}`}
                  aria-hidden="true"
                />
      ...
      <section
        id="features"
        className="mx-auto max-w-7xl px-6 py-24 [content-visibility:auto] sm:px-8 lg:px-10 lg:py-32"
      >
        <motion.div {...fadeUp} className="max-w-2xl">
          ...
          <h2 className="mt-4 text-3xl font-semibold tracking-tight text-ink sm:text-4xl">
            Everything required to ship enterprise AI.
          </h2>
          <p className="mt-5 text-base leading-7 text-muted">
            Move from prototype to production without stitching together a fragile stack of
            disconnected tools.
          </p>
        </motion.div>
            ...
            >
              <div className="h-full rounded-[calc(0.75rem-1px)] bg-surface/95 p-7">
                <motion.div
                  ...
                  className="flex h-11 w-11 items-center justify-center rounded-lg border border-line bg-canvas text-primary shadow-sm transition-colors duration-normal group-hover:border-primary/30 group-hover:bg-primary/10"
                >
                  <feature.icon className="h-5 w-5" aria-hidden="true" />
                </motion.div>
                <h3 className="mt-7 text-lg font-semibold tracking-tight text-ink">
                  {feature.title}
                </h3>
      ...
      <section
        className="border-y border-line bg-surface/30 py-24 [content-visibility:auto]"
      ...
      >
        <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
          <motion.div {...fadeUp} className="mx-auto max-w-2xl text-center">
            ...
            >
              Why Enterprise Teams Choose Aether AI
            </h2>
          </motion.div>
          <div className="mt-14 grid gap-4 lg:grid-cols-3">
            {trustItems.map((item, index) => (
              <motion.article
                ...
                className="rounded-xl border border-line bg-canvas/70 p-7 shadow-sm"
              >
      ...
      <section id="architecture" className="[content-visibility:auto]">
        <motion.div
          {...fadeUp}
          className="mx-auto grid max-w-7xl gap-10 px-6 py-24 sm:px-8 lg:grid-cols-[1fr_auto] lg:items-center lg:px-10"
        >
          <div className="max-w-2xl">
            ...
            <h2 className="mt-4 text-3xl font-semibold tracking-tight text-ink">
              Your models. Your data. One architecture.
            </h2>
            <p className="mt-4 text-sm leading-6 text-muted">
              Connect cloud and local models, ground every response in trusted knowledge, and retain
              complete visibility across the system.
            </p>
          </div>
          <a
            href="/docs"
            className="group inline-flex w-fit items-center gap-2 rounded-md border border-line bg-surface px-5 py-3 text-sm font-semibold text-ink transition-colors hover:border-primary/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-400"
          >
          ...
          <div className="grid gap-12 lg:grid-cols-[1.15fr_2fr]">
            <div>
              <div className="flex items-center gap-2 text-sm font-semibold">
                <LockKeyhole className="h-4 w-4 text-primary" aria-hidden="true" /> Aether AI
              </div>
              <p className="mt-3 max-w-xs text-xs leading-5 text-muted">
                Enterprise intelligence, orchestrated across every model, agent, and knowledge
                source.
              </p>
            </div>
                ...
                <div key={column.title}>
                  ...
                  <ul className="mt-4 space-y-3">
                    {column.links.map((link) => (
                      <li key={link}>
                        <a
                          href={link === "Features" ? "#features" : "/" + link.toLowerCase()}
